...
public class UserInfoServiceImpl implements UserInfoService{
	...
	@Override
//	@CacheEvict(value="myCache",key="#dto.getUserCde()")
	...
	public int addRole(RoleModel roleModel) {
		return userInfoMapper.addRole(roleModel);
	}
	...
	@Override
//	@Cacheable(value="myCache",key="#userCde")
	...
	public List<UserInfoDTO> findUserInfo(String userCde, String userNme,
			...
			String handler1Cde, String handler1Nme,String[] roleCodes,String[] channelTypeList,String comCode,int startIndex, int pageSize)
			throws BusinessException {
		return userInfoMapper.findUserInfo(userCde, userNme, createBegin, createEnd, dept, handler1Cde, handler1Nme,roleCodes,channelTypeList, comCode,startIndex, pageSize);
	}
	...
	public int pageCounts(String userCde, String userNme, String createBegin,
			String createEnd, String dept, String handler1Cde, String handler1Nme,String[] roleCodes,String[] channelTypeList,String comCode)
			throws BusinessException {
		return userInfoMapper.pageCounts(userCde, userNme, createBegin, createEnd, dept, handler1Cde, handler1Nme, roleCodes,channelTypeList,comCode);
	}
...
//		logger.info("================in=========");
		UserInfoDTO userInfoDTO = userInfoMapper.doUser(userCode);
		return userInfoDTO;
	}
	...
	public List<RoleModel> doRole(String userCode) {
		List<RoleModel> roleModel = userInfoMapper.doRole(userCode);
		return roleModel;
	}
	...
	@Override
	public List<PermissionModel> doPermissionModel(String roleCode) {
		List<PermissionModel> permissionModel = userInfoMapper.doPermissionModel(roleCode);
