 ...
 */
public class CombosDataResponse implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2550905895362687789L;
	...
	private RatioInfoResponse RatioInfo;
	private RatioDetailInfoResponse[] ratioDetailInfoList;
	private EngageDataResponse[] EngageList;
	private ItemKindDataResponse[] ItemKindList;
    private String sumDiscount;

	@Override
	public String toString() {
		return "CombosDataResponse{" +
	...
	public RatioInfoResponse getRatioInfo() {
		return RatioInfo;
	}

	public void setRatioInfo(RatioInfoResponse ratioInfo) {
		RatioInfo = ratioInfo;
	}

	public RatioDetailInfoResponse[] getRatioDetailInfoList() {
		return ratioDetailInfoList;
	}

	public void setRatioDetailInfoList(RatioDetailInfoResponse[] ratioDetailInfoList) {
		this.ratioDetailInfoList = ratioDetailInfoList;
	}

	public EngageDataResponse[] getEngageList() {
		return EngageList;
	}

	public void setEngageList(EngageDataResponse[] engageList) {
		EngageList = engageList;
	}

	public ItemKindDataResponse[] getItemKindList() {
		return ItemKindList;
	}

	public void setItemKindList(ItemKindDataResponse[] itemKindList) {
