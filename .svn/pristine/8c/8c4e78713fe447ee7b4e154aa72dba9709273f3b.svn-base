 ...
 */
public class RatioDetailInfoResponse implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = 6722729168643690253L;
	...
	public String toString() {
		return "RatioDetailInfoResponse{" +
