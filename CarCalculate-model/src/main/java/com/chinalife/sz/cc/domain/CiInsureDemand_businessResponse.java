 ...
 */
public class CiInsureDemand_businessResponse implements Serializable {
	/**
	 * 
	 */
	private static final long serialVersionUID = -5898640784830166103L;
	...
	public String toString() {
		return "CiInsureDemand_businessResponse{" +
				"demandNo='" + demandNo + '\'' +
				", validNo='" + validNo + '\'' +
